...
neo-Riemannian operations (e.g., leading-note,
relative, and parallel operations). At present they do
not take correct pitch spelling into account. For
instance, the operations "LPL" and "PLP" map C major
to G$\sharp$ minor and A$\flat$ minor respectively,
but both will be represented by pitch class 8. |#
